...
from .signals import permission_audit, permission_validation, request_notification, request_validation
...
class PermissionsConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        post_save.connect(request_validation, PermissionRequest)
