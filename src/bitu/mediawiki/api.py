...
from .serializers import UserTokenValidation, UserTokenValidationSerializer


class UserTokenValidatorApiView(generics.CreateAPIView):
    ...
    queryset = UserTokenValidation.objects.all()
